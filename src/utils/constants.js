...
export const DESCTOP_MIDI_INIT_CARDS = 12;
export const TABLET_INIT_CARDS = 8;
export const MOBILE_INIT_CARDS = 5;
export const DESKTOP_MORE_CARDS = 4;
export const DESCTOP_MIDI_MORE_CARDS = 3;
export const TABLET_MORE_CARDS = 2;
export const MOBILE_MORE_CARDS = 2;
export const DESKTOP_RESOLUTION = 1127;
export const MIDIDESKTOP_RESOLUTION = 983;
export const TABLET_RESOLUTION = 745;
